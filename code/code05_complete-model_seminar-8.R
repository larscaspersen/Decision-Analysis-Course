...
#read from github and save to local machine
...
# write.csv(input_table,'data/example_input_table_sem8.csv',row.names = F)

input_table <- read.csv('data/example_input_table_sem8.csv')

names(input_table)

#perform monte-carol simulartion
mcSimulation_results <- decisionSupport::mcSimulation(
  estimate = decisionSupport::estimate_read_csv("data/example_input_table_sem8.csv"),
...
plot_pls(pls_result, input_table = input_table, threshold = .8)
